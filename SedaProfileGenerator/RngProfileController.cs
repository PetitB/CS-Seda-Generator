...
namespace SedaSummaryGenerator
{
	public class RngProfileController
	{
		...
		#region Variables protégées
		// TODO: Attention, ici on en gère pas encore le fait que des xxOrMore puissent être imbriqués
		...
		#region loadExpectedTagsInArchiveNode
		...
		#region loadExpectedTagsInMainContainsNode
		...
		#region addExpectedFilePlanPositionTags
		...
		#region loadExpectedTagsInContainsNode
		...
		#region checkContainsHasContainsOrDocuments
		/// <summary>
		...
		#region checkForDescriptionLevel
		...
		#region checkForDocumentInArchive
		...
		#region checkFoArchivalAgreementInArchive
		...
		#region checkForContentDescription
		...
		#region checkForOptionalOriginatingAgency
		...
		#region checkForFilePlanPositionTag
		...
		#region checkForMultipleDocument
		/*
		...
		#region Méthode get, set et unset
		/*
